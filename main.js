...
headname[1].innerHTML = '<a class="user-profile-name" href="/user/105">某傻逼</a><a class="user-profile-badge v-center badge--lv1" href="/user/105" data-tooltip="LV -1: 没有等级">LV -1</a>';
...
var under_name = document.querySelectorAll(".section__body")
under_name[2].innerHTML = '<div class="balancer sidebar-user-stat"><div class="balancer__body"><div class="numbox"><div class="numbox__num medium">-114</div><div class="numbox__text">已通过</div></div></div><div class="balancer__body"><div class="numbox"><div class="numbox__num medium">-114</div><div class="numbox__text">题解被赞</div></div></div></div>';

console.log("为啥要禁评论 v1.2")
console.log("by HelloWorldForGao")